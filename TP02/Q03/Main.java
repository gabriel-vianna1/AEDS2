...
class Main {
    public static void main(String[] args) {
        ...
        boolean acabar = true;
        boolean[] encontrado = new boolean[30];
        int c = 0;
        ...
        do {
            ...
            if (nome.equals("FIM")) {
                ...
                for (int j = 0; j < pokemons.length && !achou; j++) { 
                    
                    if (pokemons[j] != null && pokemons[j].getName().equals(nome)) {
                        achou = true; 
                    }
                }
        ...
        try (PrintWriter escritor = new PrintWriter(new FileWriter("matricula_sequencial.txt"))) {
