...
public class Main{
    public static void main(String[] args){
        ...
        try (PrintWriter escritor = new PrintWriter(new FileWriter("matrícula_HashIndireta.txt"))) {
...
class Pokemon {
 ...
 class Hash {
    ...
    public int pesquisar(String palavra) {
       ...
       boolean achou = tabela[pos].pesquisar(palavra);
...
class Celula {
 ...
 class Lista {
	...
	void inserirFim(Pokemon elemento) {
